...
export default function Header({ onScrape, isLoading }: HeaderProps) {
  return (
    <header className="h-[60px] bg-[#161b22] border-b border-[#30363d] flex items-center px-5 justify-between shrink-0">
      <div className="flex items-center gap-2.5 font-bold text-lg">
        <svg height="32" viewBox="0 0 16 16" version="1.1" width="32" aria-hidden="true" className="fill-current">
